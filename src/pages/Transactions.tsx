            ...
            <div className="flex flex-col gap-4 md:gap-6 flex-1">
              <div className="flex flex-col md:flex-row gap-3 md:gap-4">
                ...
                <div className="flex gap-2 md:gap-3">
                  ...
                  <div className="flex bg-slate-50 dark:bg-slate-800/50 rounded-xl overflow-hidden flex-1 md:flex-none">
                    <select
                      value={sortField}
                      onChange={(e) => setSortField(e.target.value as any)}
                      className="input-field px-4 py-3 text-xs font-black uppercase tracking-widest appearance-none bg-transparent border-transparent cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center px-4 py-3 bg-transparent text-slate-700 dark:text-slate-200 hover:bg-slate-200/50 dark:hover:bg-slate-700 transition-colors"
                    >
                      {sortOrder === "desc" ? (
