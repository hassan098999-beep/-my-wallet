...
const IncomePage = () => {
  ...
  return (
    ...
    >
      ...
      {income.length > 0 && (
          <motion.div variants={itemVariants} className="glass-card p-6 md:p-8 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm h-64 md:h-80">
        ...
        <motion.form 
          ...
          className="glass-card p-6 md:p-8 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all"
        >
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <input
                  ...
                  dir="ltr"
                />
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-500 font-black text-xs md:text-sm">{currency}</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 md:mt-8 flex justify-end">
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            type="submit" 
            className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3 md:px-10 md:py-4 rounded-2xl md:rounded-3xl font-black text-sm md:text-base flex items-center justify-center gap-3 transition-all shadow-md shadow-emerald-500/30"
          >
      ...
      <motion.div variants={itemVariants} className="glass-card rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        {income.length === 0 ? (
          <div className="p-16 md:p-24 text-center">
            <div className="w-24 h-24 md:w-32 md:h-32 mx-auto bg-slate-50 dark:bg-slate-900/50 rounded-3xl flex items-center justify-center text-slate-400 mb-8 md:mb-10 shadow-inner">
              ...
              {income.map((item, index) => (
                ...
                >
                  <div className="flex items-center gap-4 md:gap-6">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center text-emerald-500 shrink-0 shadow-sm">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 md:gap-8 border-t sm:border-t-0 pt-4 md:pt-0 border-slate-100 dark:border-slate-800">
                    ...
                    <button 
                      ...
                      title="حذف"
                    >
                      <Trash size={20} className="md:size-24" />
                    </button>
                  </div>
                </motion.div>
              ))}
