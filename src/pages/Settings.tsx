...
const LAUNCHER_ITEMS = [
  ...
  { path: '/savings', name: 'الادخار والأهداف المالية', icon: PiggyBank, desc: 'إدارة الأهداف الادخارية، الحصالة النقدية وفائض الميزانية 🎯', bg: 'from-emerald-500/10 to-emerald-500/5 hover:border-emerald-500/30 border-emerald-500/15', iconColor: 'text-emerald-600' },
