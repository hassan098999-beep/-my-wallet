...
export const getFinancialAdvice = async (
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: `
        بصفتك مستشاراً مالياً ذكياً وخبيراً في الاقتصاد التونسي، قم بتحليل البيانات المالية التالية وقدم 3 نصائح عملية ومخصصة للمستخدم.
        العملة المستخدمة: الدينار التونسي (TND) - تذكر أن 1 دينار = 1000 مليم.
...
export const chatWithFinancialAdvisor = async (
  ...
  const systemInstruction = `
    أنت مساعد مالي شخصي ذكي وودود، خبير في الاقتصاد التونسي. مهمتك هي مساعدة المستخدم في إدارة أمواله بالدينار التونسي (TND).
    تحدث باللغة العربية بأسلوب احترافي ومبسط.
    
    ملاحظات هامة حول العملة:
    - العملة هي الدينار التونسي (TND).
    - 1 دينار = 1000 مليم.
    - عند عرض المبالغ، استخدم دائماً 3 أرقام بعد الفاصلة لتمثيل المليمات (مثلاً: 10.500 د.ت).
    ...
    قدم نصائح عملية تتماشى مع الواقع التونسي عند الاقتضاء.
  `;
