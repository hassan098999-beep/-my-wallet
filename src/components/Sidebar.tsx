...
import { Home, ChartPie, History, Settings, Plus, Sparkles, Wallet, RefreshCcw, Target, PiggyBank, SlidersHorizontal } from 'lucide-react';
    ...
    <div className="hidden md:flex flex-col w-64 h-full bg-slate-50 dark:bg-slate-950 border-l border-slate-200/50 dark:border-slate-800/50 relative z-40 shrink-0">
      ...
      <div className="p-4 border-t border-slate-200/50 dark:border-slate-800/50 shrink-0">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-3 px-4 bg-gradient-to-tr from-emerald-600 to-emerald-400 text-white rounded-xl shadow-lg shadow-emerald-500/30 flex items-center justify-center gap-2 transition-all font-bold group"
        >
